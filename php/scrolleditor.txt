...
<div id = "filescroll">
    ...
    <div class = "scrolls file">scrolls/layout.txt</div>
    <div class = "scrolls file">scrolls/calculations.txt</div>
    <div class = "scrolls file">scrolls/process.txt</div>
    <div class = "scrolls file">scrolls/people.txt</div>
    <div class = "scrolls file">scrolls/places.txt</div>
    <div class = "scrolls file">scrolls/machines.txt</div>
    <div class = "scrolls file">scrolls/references.txt</div>
